<div class="relative w-full px-6 mt-6 bg-white shadow-xl shadow-slate-700/10 ring-1 ring-gray-900/5 md:max-w-3xl md:mx-auto lg:pt-6 lg:pb-28">

<article class="format max-w-full">

            <h1>Privacy Policy</h1>
            <p style="text-align: justify;">The following is the privacy policy of google, so with that I will implement on my blog by e-mail address&nbsp;{{ 'contact@' . parse_url(route('home_page'), PHP_URL_HOST) }}.</p>
...
<p style="text-align: justify;">The contents of this statement may be altered at any time, at our discretion. If you have any questions regarding the privacy policy of&nbsp;{{ route('home_page') }}&nbsp;then you may&nbsp;<a href="/contact">contact us</a>.</p>
</article>
