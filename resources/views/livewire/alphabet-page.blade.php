    ...
    <aside aria-label="List Names" class="py-8 lg:py-24 bg-gray-50 dark:bg-gray-800 text-center">
        <div class="px-4 mx-auto max-w-screen-xl">
            <h2 class="mb-8 text-2xl font-bold text-gray-900 dark:text-white font-nama">
                <span class="text-6xl">Ide Nama Bayi dengan Huruf Awal {{ ucwords($param) }}</span>
            </h2>
            <p class="pb-3">
                Ayah Bunda sedang mencari ide nama bayi <strong>dengan awalan {{ ucwords($param) }}</strong>? <br>
                Kami punya <strong>{{ $names->total() }} ide nama anak dengan awalan {{ ucwords($param) }}</strong> yang bisa Ayah bunda pilih.
